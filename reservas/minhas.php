        ...
        <section class="panel stack">
            <div class="page-header">
                <div>
                    ...
                    <p class="muted">Acompanhe aceite, retirada, código de confirmação e eventual avaliação da entrega.</p>
                </div>
            </div>
            ...
            <?php if (!$reservas): ?>
                <p class="muted empty-state">Você ainda não possui reservas.</p>
            <?php endif; ?>
            ...
            <?php foreach ($reservas as $r): ?>
                <article class="panel stack">
                    <div class="page-header">
                        <div>
                            <h2><?= e($r['titulo']) ?></h2>
                            <p class="muted">Doadora: <?= e($r['doadora']) ?> · <?= (int) $r['pontos'] ?> pontos</p>
                        </div>
                    ...
                    <?php if ($r['status'] === 'aceita'): ?>
                        <div class="status-callout">
                            No encontro, peça o código de 6 caracteres para confirmar a entrega.
                        </div>
                    <?php endif; ?>
                    ...
                    <div class="action-row">
                        ...
                        <?php if (in_array($r['status'], ['aceita', 'entregue', 'no_show'], true)): ?>
                            <a class="btn danger" href="../denuncias/reportar.php?reserva_id=<?= (int) $r['id'] ?>&amp;denunciada_id=<?= (int) $r['doadora_id'] ?>">
